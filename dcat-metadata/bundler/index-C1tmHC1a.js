...
import { _ as C, d as A, F as j, G } from "./main-CbCPYW3m.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-BUz-jjPR.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-fKUvZLHW.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-D7Zo3h1d.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-DlTj3KoO.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-CxuwuszQ.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-BLMAmlo_.js")))
      }), a;
    }), n = (a) => {
