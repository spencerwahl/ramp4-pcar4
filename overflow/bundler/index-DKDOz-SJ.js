...
import { _ as H, d as L, F as X, G as ee } from "./main-BCnSPykw.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-By-hhb4m.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-z-DbIwzQ.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-D6PYMJt0.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DWKGVLOn.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-D2mC44YI.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-DA7lV8Xj.js")))
      }), s;
    }), n = (s) => {
