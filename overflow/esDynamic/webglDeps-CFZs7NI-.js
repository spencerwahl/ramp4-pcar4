import{o as m}from"./BufferObject-8P13gbU6.js";import{m as p,s as u}from"./FramebufferObject-VCIyf4Tq.js";import{s as c}from"./ProgramTemplate-Db0E74Wd.js";import{e as l,a as d}from"./ProgramTemplate-Db0E74Wd.js";import"./main-gbnFE5KZ.js";import{A as $}from"./Texture-CsDcfnPf.js";import{h}from"./VertexArrayObject-igrBM4Py.js";class b{constructor(e){this._rctx=e,this._store=new Map}dispose(){this._store.forEach(e=>e.dispose()),this._store.clear()}acquire(e,t,r,s){const i=e+t+JSON.stringify(Array.from(r.entries())),o=this._store.get(i);if(o!=null)return o.ref(),o;const n=new c(this._rctx,e,t,r,s);return n.ref(),this._store.set(i,n),n}get test(){}}function y(a){const{options:e,value:t}=a;return typeof e[t]=="number"}function _(a){let e="";for(const t in a){const r=a[t];if(typeof r=="boolean")r&&(e+=`#define ${t}
