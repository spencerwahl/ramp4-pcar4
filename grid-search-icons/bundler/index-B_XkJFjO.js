...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-JjsdQgp9.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-0E3xrf2p.js"), "./icons/edit-icon.vue": () => import("./edit-icon-C8DOuDqB.js"), "./icons/point-icon.vue": () => import("./point-icon-Cpj1N_DA.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-K6F5Utpg.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-DAT8fG7v.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-6BK3s5oV.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
