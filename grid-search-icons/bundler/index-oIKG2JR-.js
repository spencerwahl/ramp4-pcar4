...
import { _ as H, d as L, F as X, G as ee } from "./main-JjsdQgp9.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-Cpj1N_DA.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-DAT8fG7v.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-K6F5Utpg.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-0E3xrf2p.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-6BK3s5oV.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-C8DOuDqB.js")))
      }), s;
    }), n = (s) => {
