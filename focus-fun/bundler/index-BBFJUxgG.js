...
import { _ as H, d as L, F as X, G as ee } from "./main-DFylW_Us.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DLwbCzVZ.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-DX7die2O.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-Cuam4cRJ.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-C5MASfn_.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BvnmyR83.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CQAN8y8C.js")))
      }), s;
    }), n = (s) => {
