...
class re extends rt {
  ...
  rawArray;
  constructor(e, t, i, s) {
    super(e, t.sr || i), s ? this.rawArray = t.slice() : this.rawArray = re.parseXY(t);
  }
...
class H extends rt {
  ...
  rawMax;
  constructor(e, t, i, s) {
    super(e, t.sr || s), this.rawMin = re.parseXY(t), this.rawMax = re.parseXY(i);
  }
...
const rr = ["data-cy"], Ki = /* @__PURE__ */ N({
  ...
  setup(r) {
    const e = Be(), { t } = ie(), i = D(() => e.notificationNumber), s = () => e.clearAll();
    return (a, o) => {
...
const hr = ["content"], fr = { class: "flex items-center text-left" }, mr = { class: "select-text cursor-text" }, yr = ["content", "aria-label"], gr = {
  ...
  __name: "map-caption",
  setup(r) {
    const e = Ye(), t = Xi(), i = be(), { t: s } = ie(), a = Se("iApi"), o = D(() => e.scale), l = D(() => e.attribution), n = D(() => e.coords), c = D(() => e.langtoggle), u = D(() => i.config.map), { keyChain: p, lastAction: d, chainState: g, namespaces: h, activeNamespace: m } = hs(t), A = D(() => {
          ...
          c.value?.disabled ? z("", !0) : (b(), ee(M, {
            ...
            default: ue(() => [
              (b(!0), w(tt, null, bt(v.value, (J, E) => (b(), w("a", {
                ...
                J === I(a).$i18n.locale.value ? (b(), w("span", ca, B(I(s)("map.language.curr")), 1)) : z("", !0)
              ], 10, la))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    const e = Be(), t = Se("iApi"), { t: i } = ie(), s = D(() => e.notificationNumber);
    return (a, o) => {
      const l = G("tippy");
      return U((b(), w("button", {
        type: "button",
        ...
        s.value && s.value > 0 ? (b(), w("span", da, B(s.value), 1)) : z("", !0)
      ], 8, pa)), [
        [l]
      ]);
    };
  ...
  setup(r) {
    const e = Se("iApi"), { t } = ie(), i = f(!1), s = f(["app", "lists", "map", "keyboardNav"]), a = f([]), o = f(null), l = f(null);
    st(() => {
      a.value.push(
  ...
  __name: "shell",
  setup(r) {
    const e = Se("iApi"), t = ut(), i = Ee(), s = it(), { t: a } = ie(), o = D(() => i.items.appbar), l = () => {
...
const La = /* @__PURE__ */ qe(Sa, [["render", Ta]]), Oe = "focus-list", Qe = "focus-item", Ra = "focus-icon", $a = "focus-container", yt = `[${Oe}],[${$a}]`, Tt = "truncate-text", Lt = "show-truncate", dt = "focused", Zt = `button,input,select,a,textarea,[contenteditable],[${Oe}],[${Ra}],[tabIndex]`, Ca = {
  mounted(r, e) {
...
class Oa {
   ...
   */
  defocusItem(e) {
    e.classList.remove(dt), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(Qe) === Lt && e.querySelector(`[${Tt}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(dt), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(Qe) === Lt && e.querySelector(`[${Tt}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
    ...
    if (i.length !== 0)
      switch (e.key) {
        ...
        case "Tab":
          ...
          this.highlightedItem !== this.element && a && (s && this.defocusItem(this.highlightedItem), e.shiftKey && (e.preventDefault(), e.stopPropagation(), this.defocusItem(this.highlightedItem), this.highlightedItem = this.element, this.element.removeAttribute("aria-activedescendant"), this.element.focus()));
      }
  }
  /**
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(Qe) === Lt && this.highlightedItem.querySelector(`[${Tt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), es(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
   ...
   */
  onBlur() {
    this.highlightedItem && (this.highlightedItem._tippy && this.highlightedItem._tippy.hide(), this.highlightedItem.getAttribute(Qe) === Lt && this.highlightedItem.querySelector(`[${Tt}]`)?._tippy?.hide());
  }
  /**
...
const za = ["content"], qa = {
  ...
  setup(r, { expose: e }) {
    const { t } = ie(), i = it(), s = Ft(), a = Se("iApi"), o = yi("el"), l = yi("contentEl"), n = f();
    e({ el: o });
    ...
    return st(() => {
      ...
      return U((b(), w("div", {
        ...
        r.header ? (b(), w("header", qa, [
          ...
          U((b(), w("h2", ja, [
            v.$slots.header ? Ve(v.$slots, "header", { key: 0 }) : (b(), w("div", Ha, B(I(t)(r.panel.alertName)), 1))
          ])), [
            [q]
          ]),
          ...
          y("div", {
            ...
            r.panel.teleport ? z("", !0) : (b(), w("div", Wa, [
              d.value ? (b(), ee(V, {
                key: 0,
      ...
      if (this._visibility = e ?? !this.visibility, !this.exclusive)
        ...
        if (this._lastVisible && (!(this._lastVisible instanceof He) || this._lastVisible.layerControlAvailable(X.Visibility)))
          ...
          const i = this.children.find(
            (s) => !(s instanceof He) || s.layerControlAvailable(X.Visibility)
          );
    ...
    if (e ? (e.logo ? e.logo.disabled ? s.logo.disabled = !0 : (s.logo.altText = e.logo.altText || i.altText, s.logo.link = e.logo.link || i.link, s.logo.value = e.logo.value || i.value) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value), e.text ? e.text.disabled ? s.text.disabled = !0 : s.text.value = e.text.value || t.value : s.text.value = t.value, Ye(this.$vApp.$pinia).setAttribution(s)) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value, s.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      if (n) {
        ...
        Promise.all(c).then((u) => {
          a = u.filter((d) => d?.copyright).map((d) => d.copyright).join(" | "), s.text.value = a || s.text.value || t.value, Ye(this.$vApp.$pinia).setAttribution(s);
        });
      }
    }
  }
...
class Ln extends se {
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, a = {
    ...
    const c = new Nt(e).updateQuery(l), [u, p] = await Re(_t.get(c));
    if (!p)
      return console.error(`WFS data failed to load for ${e}`, u), Promise.reject(u);
    const d = p.data;
    if (t === -1)
      return t = p.data.numberMatched, this.loadWfsData(e, t, i, s, a, o);
...
class ot extends ui {
  ...
  async getGraphic(e, t) {
    ...
    if (!t.getGeom && this.attribs.attLoader.isLoaded()) {
      ...
      i = new $e(new Ze(), "", s.features[s.oidIndex[e]]);
    } else {
      const s = {
        filterOIDs: [e],
...
class sl extends se {
  ...
  async getMapServerLegend(e) {
    ...
    const t = {
      query: { f: "json" }
    }, i = { layers: [] }, [s, a] = await Re(Ke(`${e}/legend`, t));
...
class rl extends se {
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((s, a) => {
      let o;
      return t.returnGeometry ? o = this.$iApi.geo.geom.geomEsriToRamp(s.geometry, `queryResult${a}`) : o = new Ze(), new $e(o, "", s.attributes);
    });
  }
  /**
...
const ol = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-1WdShpDb.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-ze-yEORI.js"), "../fixtures/basemap/index.ts": () => import("./index-D9V7NKES.js"), "../fixtures/crosshairs/index.ts": () => import("./index-CEppz5er.js"), "../fixtures/details/index.ts": () => import("./index-DY3Rdzov.js"), "../fixtures/draw/index.ts": () => import("./index-CaUHpfUp.js"), "../fixtures/export-footnote/index.ts": () => import("./index-DGDeTZUn.js"), "../fixtures/export-legend/index.ts": () => import("./index-BeAm-tZr.js"), "../fixtures/export-map/index.ts": () => import("./index-Brr-hFSJ.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Bgp1XWYM.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DTAVe1nB.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-BCTQpFBo.js"), "../fixtures/export-title/index.ts": () => import("./index-DVL0V1b1.js"), "../fixtures/export/index.ts": () => import("./index-CEPDRSnU.js"), "../fixtures/extentguard/index.ts": () => import("./index-CvqJQjRm.js"), "../fixtures/gazebo/index.ts": () => import("./index-DQOl9DBf.js"), "../fixtures/geosearch/index.ts": () => import("./index-i13WSiCV.js"), "../fixtures/grid/index.ts": () => import("./index-BzRPhO77.js"), "../fixtures/help/index.ts": () => import("./index-BkUr4eT3.js"), "../fixtures/hilight/index.ts": () => import("./index-BINs-Pfs.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-BfnjHDrc.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-COoOWSxO.js"), "../fixtures/legend/index.ts": () => import("./index-CbUl4RRV.js"), "../fixtures/mapnav/index.ts": () => import("./index-BBFJUxgG.js"), "../fixtures/metadata/index.ts": () => import("./index-D-FS1NYe.js"), "../fixtures/northarrow/index.ts": () => import("./index-8A--XQCR.js"), "../fixtures/overviewmap/index.ts": () => import("./index-BJWOOc2V.js"), "../fixtures/panguard/index.ts": () => import("./index-B1_BFsjO.js"), "../fixtures/scrollguard/index.ts": () => import("./index-BiTLJWdQ.js"), "../fixtures/settings/index.ts": () => import("./index-BTyj5j1x.js"), "../fixtures/snowman/index.ts": () => import("./index-DwdN8VPl.js"), "../fixtures/swipe/index.ts": () => import("./index-BKsv685P.js"), "../fixtures/wizard/index.ts": () => import("./index-CUMGlm_w.js") });
class nl extends se {
  /**
...
const dl = /* @__PURE__ */ qe(ul, [["render", pl], ["__scopeId", "data-v-a3c61802"]]), hl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-Dps84ZUk.js"), "../fixtures/basemap/screen.vue": () => import("./screen-2Z-bC6DG.js"), "../fixtures/export/screen.vue": () => import("./screen-CH-b_3rg.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-D3B6nnbX.js"), "../fixtures/grid/screen.vue": () => import("./screen-CeVY8qGQ.js"), "../fixtures/help/screen.vue": () => import("./screen-4pq4bdH9.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-0tPdy1xc.js"), "../fixtures/legend/screen.vue": () => import("./screen-LBzwEpVq.js"), "../fixtures/metadata/screen.vue": () => import("./screen-qHqep4vH.js"), "../fixtures/settings/screen.vue": () => import("./screen-BkZmN6HQ.js"), "../fixtures/wizard/screen.vue": () => import("./screen-Dr_xtMPu.js") });
class Ct extends se {
  /**
   * ID of this panel.
   *
...
var pt = { major: "4", minor: "15", patch: "0-beta", timestamp: "Tue Jan 20 09:16:58 2026 -0500", hash: "01090445d640744c4554a668387b55de790b8a3e" };
console.info(
