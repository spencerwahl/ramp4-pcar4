...
import { _ as C, d as A, F as j, G } from "./main-BaZpjxoA.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-BQKPJvC-.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-BsvsoyUN.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-BXm3thi5.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-CHa3VgV-.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-DIy6-46m.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-nzydiwqo.js")))
      }), a;
    }), n = (a) => {
